<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="<?php echo e(url('/')); ?>"> <img title="Nombre empresa" alt="Nombre empresa" src="<?php echo e(asset("assets/images/default-image.jpg")); ?>" style="background-color: transparent;border-color: transparent;" class="img-thumbnail"/> <span
      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown active">
          <a href="<?php echo e(url('/')); ?>" class="" style="background:transparent; color:<?php echo e($data['panel_configuraciones']->color_tema ?? 'grey'); ?>;"><i class="fas fa-store-alt" style="font-size:24px;margin-left:-1px;"></i><span>Inicio</span></a>
        </li>
  ...
  </div><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>