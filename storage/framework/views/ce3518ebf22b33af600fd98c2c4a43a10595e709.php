            ...
            <div class="section-body">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                                    ...
                                    <tbody id="tbody_generico">
                                        <?php $__currentLoopData = $data['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="space-align-center">
                                                    <a onclick='editarGenerico("<?php echo e($g->id); ?>","<?php echo e($g->codigo ?? ''); ?>","<?php echo e($g->rol ?? ''); ?>","<?php echo e($g->tipo_gasto_id ?? ''); ?>","<?php echo e($g->tipo_ingreso_id ?? ''); ?>","<?php echo e($g->administrador ?? 'N'); ?>","<?php echo e($g->cierra_caja ?? 'N'); ?>")'
                                                        title="Editar" class="btn btn-primary" style="color:white"><i
                                                            class="fas fa-cog"></i></a>
                                                    <a onclick="eliminarGenerico(<?php echo e($g->id); ?>)" title="Eliminar"
                        ...
                        <form id="frmEliminarGenerico" action="<?php echo e(URL::to('eliminarrol')); ?>" style="display: none"
                            method="POST">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/mant/roles.blade.php ENDPATH**/ ?>