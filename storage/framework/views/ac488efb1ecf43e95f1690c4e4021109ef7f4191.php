          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="precio_mayoreo" name="precio_mayoreo" value="<?php echo e($data['datos']['precio_mayoreo'] ??""); ?>" required min="0">
              </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/bodega/producto/nuevoProducto.blade.php ENDPATH**/ ?>