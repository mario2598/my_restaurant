...
<div class="main-content">
      ...
      <div class="section-body">
        ...
        <div class="card card-warning">
          <div class="card-header">
            <h4>Menú de restaurante RES-<?php echo e($data['restaurante']->id ?? "##"); ?> de la sucursal <?php echo e($data['restaurante']->sucursal_descripcion ?? ""); ?></h4>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="tablaMenus" >
                  ...
                  <tbody id="tbody_generico">
                    <?php $__currentLoopData = $data['menusRestaurante']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="space_row_table" style="cursor: pointer;" onclick='clickProducto("<?php echo e($g->id); ?>")'>
                        ...
                        <td class="text-center">
                            <a  style="cursor: pointer; color: white;" class="btn btn-primary" onclick="eliminarProdcutoDeMenu('<?php echo e($g->id); ?>')" >Eliminar del menú</a>
                        </td>
  ...
  <form id="form_eliminar_menu" action="<?php echo e(URL::to('restaurante/menus/productos/eliminar')); ?>"  autocomplete="off" method="POST" >
    <?php echo e(csrf_field()); ?>

    <input type="hidden" name="restaurante_id_eliminar" value="<?php echo e($data['restaurante']->id ?? "-1"); ?>">
...
aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="<?php echo e(URL::to('restaurante/menus/productos/agregar')); ?>"  autocomplete="off" method="POST" >
            <?php echo e(csrf_field()); ?>
            ...
            <div class="modal-body">
              <div class="row">
                <input type="hidden" name="restaurante_id" value="<?php echo e($data['restaurante']->id ?? "-1"); ?>">
...
<script src="<?php echo e(asset("assets/js/page/datatables.js")); ?>"></script>
  <script src="<?php echo e(asset("assets/js/restaurante/menus/editar.js")); ?>"></script>
  

     
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/restaurante/menus/editar.blade.php ENDPATH**/ ?>