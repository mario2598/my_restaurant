    ...
    <section class="section">
      <div class="section-body">
        ...
        <div class="card card-warning">
          ...
          <div class="card-body">
            <form action="<?php echo e(URL::to('bodega/productos/filtro')); ?>" method="POST">
            ...
            <div class="row" style="width: 100%">
              ...
              <div class="col-sm-12 col-md-2">
                <div class="form-group">
                  <label>Nuevo</label>
                <a href="<?php echo e(url('bodega/producto/nuevo')); ?>" class="btn btn-success btn-icon form-control" style="cursor: pointer;color:white;"><i class="fas fa-plus"></i> Agregar</a>
                </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="tablaProductos" >
                  ...
                  <tr class="space_row_table" style="cursor: pointer;" onclick='clickProducto("<?php echo e($g->id); ?>")'>
                      ...
                      <td class="text-center">
                        CRC <?php echo e(number_format($g->precio_mayoreo ?? '0.00',2,".",",")); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/bodega/productos.blade.php ENDPATH**/ ?>