    ...
    <div class="main-content">
        <section class="section">
            <div class="row" id="contenedor_comandas">
                <?php $__currentLoopData = $data['ordenes_listas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card-header" style="padding: 5px !important;">
                                ...
                                <div class="card-header-action">
                                    <a class="btn btn-icon btn-success" style="cursor: pointer"
                                        onclick='terminarEntrega(<?php echo e("$p->id"); ?>)' title="Teminar preparación orden"><i
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/facturacion/ordenesEntrega.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/facturacion/ordenesEntrega.blade.php ENDPATH**/ ?>