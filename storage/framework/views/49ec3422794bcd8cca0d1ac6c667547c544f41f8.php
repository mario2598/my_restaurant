...
<div class="main-content">
    <section class="section">
      <form method="POST" action="<?php echo e(URL::to('bodega/producto/guardar')); ?>"   autocomplete="off">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                <label>* Nombre </label>
                <input type="text" class="form-control" id="nombre" name="nombre"  value="<?php echo e($data['producto']->nombre ??""); ?>" required maxlength="25">
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="precio_mayoreo" step=any name="precio_mayoreo" value="<?php echo e($data['producto']->precio_mayoreo ??""); ?>" required min="0">
              </div>
            </div>
  ...
  <form id="formEliminarProducto" action="<?php echo e(URL::to('bodega/producto/eliminar')); ?>" style="display: none"  method="POST">
    <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/bodega/producto/editarProducto.blade.php ENDPATH**/ ?>