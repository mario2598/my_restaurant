        ...
        <section class="section">
            <div class="section-body">
                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(URL::to('materiaPrima/inventario/inventarios/filtro')); ?>" method="POST">
                                ...
                                <table class="table table-striped" id="tablaInventarios">
                                    ...
                                    <tbody id="tbody_generico">
                                        <?php $__currentLoopData = $data['inventarios']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="cursor: pointer" onclick='editarProductoInventario("<?php echo e($i->ms_id); ?>","<?php echo e($i->id); ?>","<?php echo e($i->cantidad); ?>"," <?php echo e($i->nombre); ?>")'>
                                                ...
                                                <td class="text-center">
                                                    <?php echo e($i->unidad_medida ?? ''); ?>

                                                </td>
                                               
                                                <td class="text-center">
                                                    <?php echo e($i->nombre_prov ?? ''); ?>
    ...
    <div class="modal fade bs-example-modal-center" id='mdl_agregar_producto' tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="<?php echo e(URL::to('materiaPrima/inventario/inventarios/guardar')); ?>" autocomplete="off"
                    method="POST">
                    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/materiaPrima/inventario/inventarios.blade.php ENDPATH**/ ?>