...
<div class="main-content">
    <section class="section">
      <div class="section-body">
        ...
        <div class="card card-warning">
          ...
          <div class="card-body">
            <form action="<?php echo e(URL::to('restaurante/productos/filtro')); ?>" method="POST">
            ...
            <div class="row" style="width: 100%">
              ...
              <div class="col-sm-12 col-md-2">
                <div class="form-group">
                  <label>Nuevo</label>
                <a href="<?php echo e(url('restaurante/producto/nuevo')); ?>" class="btn btn-success btn-icon form-control" style="cursor: pointer;color:white;"><i class="fas fa-plus"></i> Agregar</a>
                </div>
    ...
    <form id="formEditarProducto" action="<?php echo e(URL::to('restaurante/producto/editar')); ?>" style="display: none"  method="POST">
      <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/restaurante/productos.blade.php ENDPATH**/ ?>