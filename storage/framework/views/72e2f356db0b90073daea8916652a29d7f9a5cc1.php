          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="precio_compra" name="precio_compra" step="any" value="<?php echo e($data['datos']['precio_compra'] ??""); ?>" required min="0">
              </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/productoExterno/nuevo.blade.php ENDPATH**/ ?>