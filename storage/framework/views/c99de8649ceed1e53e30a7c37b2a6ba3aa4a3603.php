...
<div class="main-content">
  ...
  <section class="section">
            ...
            <div class="table-responsive">
              <table class="table table-striped" id="">
                ...
                <tbody id="tbody_generico">
                  <?php $__currentLoopData = $data['impuestos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td class="space-align-center">
                    <?php echo e($g->impuesto ?? "0"); ?> %
                  </td>
                  <td class="space-align-center" >
                    <a onclick='editarGenerico("<?php echo e($g->id); ?>","<?php echo e($g->descripcion ?? ""); ?>","<?php echo e($g->impuesto ?? "0"); ?>")'  title="Editar" class="btn btn-primary" style="color:white"><i class="fas fa-cog"></i></a> 
    ...
    <form id="frmEliminarGenerico" action="<?php echo e(URL::to('eliminarimpuesto')); ?>"  style="display: none" method="POST" >
...
aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="<?php echo e(URL::to('guardarimpuesto')); ?>"  autocomplete="off" method="POST" >
            <?php echo e(csrf_field()); ?>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset("assets/js/mant_impuestos.js")); ?>"></script>
  

     
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/mant/impuestos.blade.php ENDPATH**/ ?>