...
<div class="main-content">
            ...
            <div class="row" style="width: 100%">
              <div class="col-sm-12 col-md-2">
                <div class="form-group">
                  <a class="btn btn-primary" title="Agregar Tipo Gasto" style="color:white;" onclick="nuevoGenerico()">+ Agregar</a>
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="">
                  ...
                  <tbody id="tbody_generico">
                    <?php $__currentLoopData = $data['tipos_gasto']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
    ...
    <form id="frmEliminarGenerico" action="<?php echo e(URL::to('eliminartipogasto')); ?>"  style="display: none" method="POST" >
 ...
 aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
           <form action="<?php echo e(URL::to('guardartipogasto')); ?>"  autocomplete="off" method="POST" >
             <?php echo e(csrf_field()); ?>
             ...
             <div class="modal-header">
               ...
               <div class="spinner-border" id='modal_spinner' style='margin-right:3%;display:none;' role="status"></div>
                 <h5 class="modal-title mt-0" id="edit_cliente_text"><i class="fas fa-cog"></i> Tipo Gasto</h5>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset("assets/js/tipos_gasto.js")); ?>"></script>
  

     
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/mant/tipos_gasto.blade.php ENDPATH**/ ?>