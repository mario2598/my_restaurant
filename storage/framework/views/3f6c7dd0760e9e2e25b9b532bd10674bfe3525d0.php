...
<div class="main-content">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <select class="form-control" id="tipo_comanda" name="tipo_comanda">
                  <option value="CO" 
                    <?php if("CO" == ($data['producto']->tipo_comanda )): ?>
                        selected
                    <?php endif; ?>
                    >COCINA</option>
                  <option value="BE" 
  ...
  <form id="formEliminarProducto" action="<?php echo e(URL::to('restaurante/producto/eliminar')); ?>" style="display: none"  method="POST">
    <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\Space Rest\resources\views/restaurante/producto/editarProducto.blade.php ENDPATH**/ ?>