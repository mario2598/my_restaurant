                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipo_comanda" name="tipo_comanda">
                                        <option value="BE" <?php if('BE' == $data['producto']->tipo_comanda): ?> selected <?php endif; ?>>GEN BEB
                                        </option>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\2023\Laravel\CoffeeToGo\resources\views/productosMenu/producto/nuevoProducto.blade.php ENDPATH**/ ?>