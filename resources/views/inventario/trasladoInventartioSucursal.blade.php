            ...
            <div class="section-body">
                <div class="row">
                                    ...
                                    <tbody id="tbody_inventario">
                                        @foreach ($data['inventario_por_lote'] ?? [] as $i)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                <button class="btn btn-icon btn-success" onclick='agregarProductoTraslado("{{$i->id}}")'
                                ...
                                <table class="table table-striped" id="tablaDetalle">
                                    ...
                                    <tbody id="tbody_traslado">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-icon btn-success" onclick='eliminarProductoTraslado("{{$i->id}}")'
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <a onclick='aplicarTrasladoSucursal("{{$data["sucursalAuth"]}}")'
...
@section('script')
    ...
    <script src="{{ asset('assets/js/inventario/trasladoSucursal.js') }}"></script>
