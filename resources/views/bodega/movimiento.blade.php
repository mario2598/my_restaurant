                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-8">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <div class="form-group mb-0">
                                                <label>Detalle</label>
                                                <textarea class="form-control" name="observacion" id="detalle_movimiento_generado"
                                ...
                                @if ($data['movimiento']->estado == 'P')
                                    <a onclick='cancelarMovimiento("{{$data["movimiento"]->id}}")' style="cursor: pointer; color:white;" class="btn btn-warning" >Cancelar</a>
                                @endif
