...
<div class="main-content">
    ...
    <form id="frmEliminarGenerico" action="{{URL::to('eliminartipogasto')}}"  style="display: none" method="POST" >
      {{csrf_field()}}
 ...
 aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
           <form action="{{URL::to('guardartipogasto')}}"  autocomplete="off" method="POST" >
             {{csrf_field()}}
...
@section('script')
  ...
  <script src="{{asset("assets/js/tipos_gasto.js")}}"></script>
