              ...
              <div class="table-responsive">
                <table class="table table-striped" id="">
                  ...
                  <tr>
                    ...
                    <td class="space-align-center" >
                      <a onclick='editarGenerico("{{$g->id}}","{{$g->categoria ?? ""}}","{{$g->codigo ?? ""}}")'  title="Editar" class="btn btn-primary" style="color:white"><i class="fas fa-cog"></i></a> 
 ...
 aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
           <form action="{{URL::to('guardarcategoria')}}"  autocomplete="off" method="POST" >
             {{csrf_field()}}
