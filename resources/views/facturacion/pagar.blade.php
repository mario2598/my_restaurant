...
@section('content')
    ...
    <script>
        var orden = {
            ...
            "total_cancelado": "{{ $data['orden']->total_cancelado }}"
        };
                        ...
                        <div class="col-12 col-xs-12 card" style="padding:10px;">
                            <div class="row" style="padding-top:8px; padding-left:8px;">
                                <div class="col-sm-12 col-md-4 col-lg-3">
                                    ...
                                    <h6 class="text-muted">
                                        {{ $data['orden']->nombre_cajero ?? 'Usuario' }}
                                    </h6>
                                </div>
                                <div class="col-sm-12 col-md-4 col-lg-3">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-2">
                                    ...
                                    <h6 class="text-muted"> {{ date('d-m-Y') }}</h6>
                                </div>
                                ...
                                <div class="col-xs-12 col-md-12 col-lg-4">
                                    <ul class="nav nav-pills d-flex flex-row justify-content-end" id="nv-acciones"
                                        ...
                                        <button type="button" class="btn btn-info px-2 mr-1" style="margin-top: 5px;"
                                            onclick='goFacturaOrden("{{ $data["orden"]->id }}")'>Editar orden <i class="fas fa-cog"
                                                aria-hidden="true"></i></button>
                                            ...
                                            <div class="d-flex flex-row px-3">
                                                <div class="col-4 d-flex flex-row justify-content-start mt-3 mb-2">
                                                    ...
                                                    <h6 class="text-muted" style="margin-left: 3%" id="lbl-total-general">
                                                       ORD-{{ $data['orden']->numero_orden }}</h6>
                                                </div>
                                                ...
                                                <div class="form-group col-12 mb-0 px-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="hidden" name="txt-id-cliente"
                                                            value="{{ $data['orden']->cliente ?? '' }}" id="txt-id-cliente"
                                                            value="-1">
                                                        <input type="text" class="form-control h-75" name="txt-cliente"
                                                            id="txt-cliente"
                                                            value="{{ $data['orden']->nombre_cliente ?? '' }}"
    ...
    <form id="frm-crear-orden" action="{{ URL::to('facturacion/facturar') }}" method="GET">
        {{ csrf_field() }}
    </form>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/facturacion/pagar.js') }}"></script>
