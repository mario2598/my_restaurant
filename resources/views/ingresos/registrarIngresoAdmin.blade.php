                      ...
                      <div class="col-sm-12 col-md-6 col-xl-4">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" step=any id="monto_efectivo" name="monto_efectivo" value="{{$data['datos']['monto_efectivo'] ??""}}" placeholder="0.00" min="0">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" step=any id="monto_tarjeta" name="monto_tarjeta" value="{{$data['datos']['monto_tarjeta'] ??""}}" placeholder="0.00" min="0">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          ...
                          <input type="number" class="form-control" step=any id="monto_sinpe" name="monto_sinpe" value="{{$data['datos']['monto_sinpe'] ??""}}" placeholder="0.00"  min="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                              ...
                              <select class="form-control" name="tipo_ingreso">
                                  ...
                                  <option value="{{$i->id}}" title="{{$i->tipo ?? ''}}" 
                                    @if ($i->id == ($data['datos']['tipo_ingreso'] ?? -1))
                                        selected
                                    @endif
                                    >{{$i->tipo}}</option>
                                 @endforeach
