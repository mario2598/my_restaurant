                                            ...
                                            <div class="form-group">
                                                <label>Monto Efectivo (CRC)
                                                     @if ($data['tieneReporteCajero'])
                                                      <strong> 
                                                        - Reportado {{ number_format($data['reporte_cajero']->monto_efectivo ?? '0.00', 2, '.', ',') }}
                                                      </strong>
                                                    @endif
                                                </label>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label>Monto Tarjeta (CRC)
                                                  @if ($data['tieneReporteCajero'])
                                                    <strong> 
                                                      - Reportado {{ number_format($data['reporte_cajero']->monto_tarjeta ?? '0.00', 2, '.', ',') }}
                                                    </strong>
                                                  @endif
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label>Monto SINPE (CRC) 
                                                  @if ($data['tieneReporteCajero'])
                                                    <strong> 
                                                      - Reportado {{ number_format($data['reporte_cajero']->monto_sinpe ?? '0.00', 2, '.', ',') }}
                                                    </strong>
                                                  @endif
                                                </label>
