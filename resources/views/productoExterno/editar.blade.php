          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="precio_compra" name="precio_compra" step="any" value="{{$data['producto']->precio_compra ??""}}" required min="0">
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-4">
              <div class="form-group">
                ...
                <select class="form-control" id="proveedor" name="proveedor">
                  ...
                  <option value="{{$i->id}}"
                    @if ($i->id == ($data['producto']->proveedor ?? -1))
                        selected
                    @endif
                    >{{$i->nombre}}</option>
                 @endforeach
