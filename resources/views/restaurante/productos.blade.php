...
<div class="main-content">
    <section class="section">
      <div class="section-body">
        ...
        <div class="card card-warning">
          ...
          <div class="card-body">
            <form action="{{URL::to('restaurante/productos/filtro')}}" method="POST">
            {{csrf_field()}}
            <div class="row" style="width: 100%">
              ...
              <div class="col-sm-12 col-md-2">
                <div class="form-group">
                  <label>Nuevo</label>
                <a href="{{url('restaurante/producto/nuevo')}}" class="btn btn-success btn-icon form-control" style="cursor: pointer;color:white;"><i class="fas fa-plus"></i> Agregar</a>
                </div>
    ...
    <form id="formEditarProducto" action="{{URL::to('restaurante/producto/editar')}}" style="display: none"  method="POST">
      {{csrf_field()}}
